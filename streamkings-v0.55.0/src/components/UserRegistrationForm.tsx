        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            >
              ...
              <option value="DJ" disabled className="opacity-50">DJ/Streamer - If you believe in your voice for the people</option>
              <option value="ARTIST" disabled className="opacity-50">Artist - Musicians, DJs, Composers</option>
            </select>
          </div>
