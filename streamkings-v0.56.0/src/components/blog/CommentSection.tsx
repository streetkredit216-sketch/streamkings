      ...
      {loading ? (
        ...
        <div className="space-y-4">
          {comments.map((comment) => (
            <div key={comment.id} className="bg-white/5 rounded-lg p-3 sm:p-4 w-full overflow-hidden min-w-0">
              <div className="flex items-start space-x-2 sm:space-x-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-white/90 mt-2 break-words" style={{ wordBreak: 'break-word', overflowWrap: 'anywhere' }}>{comment.content}</p>
