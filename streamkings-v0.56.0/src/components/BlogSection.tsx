      ...
      return (
        <div className="fixed inset-0 z-[60] bg-black/80 backdrop-blur-sm overflow-y-auto">
          <div className="min-h-full flex items-start justify-center p-2 sm:p-6">
            <div className="relative w-full max-w-2xl sm:max-w-3xl bg-zinc-900 my-4 sm:my-8 rounded-xl mx-auto">
              <div className="sticky top-0 z-10 bg-zinc-900 px-2 sm:px-6 py-4 sm:py-6 border-b border-white/10 rounded-t-xl">
                <button
                ...
                <div className="bg-white/5 rounded-lg p-3 sm:p-6">
                  <div className="flex flex-col sm:flex-row items-start gap-2 sm:gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <h1 className="text-xl sm:text-2xl font-bold mt-2 sm:mt-4 text-white break-words">{selectedBlog?.title}</h1>
                      <p className="mt-2 sm:mt-4 text-white/90 whitespace-pre-wrap leading-relaxed break-words" style={{ wordBreak: 'break-word', overflowWrap: 'anywhere' }}>{selectedBlog?.content}</p>
    ...
    if (viewMode === 'blogs') {
      return (
        <div className="min-h-full w-full bg-transparent relative">
          {/* Sentinel at top of BlogSection to detect when scrolled past radio */}
          <div id="blog-section-sentinel" className="absolute top-0 left-0 w-full h-1 pointer-events-none" />
          <NavigationMenu
            user={user}
            viewMode={viewMode}
            view={view}
